...
describe Graph do
  ...
  it 'finds an element in the graph' do
    ...
    expect(@graph.bfs(1, 5)).to be true
  end
  ...
  it 'works with a disconnected graph' do
    ...
    expect(@graph.bfs(1, 4)).to be false
  end
end
